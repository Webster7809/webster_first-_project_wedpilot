          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Container(width: 16, height: 16, decoration: BoxDecoration(color: AppColors.error.withAlpha(38), shape: BoxShape.circle, border: Border.all(color: AppColors.error))),
