        ...
        child: SizedBox(
          ...
          child: Row(
            children: [
              ...
              ShellNavItem(icon: Icons.star_outline_rounded, activeIcon: Icons.star_rounded, label: 'Reviews', index: 3, currentIndex: currentIndex, onTap: onTap),
              ShellNavItem(icon: Icons.person_outline_rounded, activeIcon: Icons.person_rounded, label: 'Account', index: 4, currentIndex: currentIndex, onTap: onTap),
            ],
          ),
        ),
      ),
